...
<template>
    ...
    >
        ...
        >
            ...
            >
                <div
                    class="bg-white flex-1 rounded-br-lg rounded-bl-lg p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"
                >
                    <h1 class="mb-1 font-medium">Lets get started</h1>
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            <span
                                class="bg-white relative py-1 dark:bg-[#161615]"
                            >
                                <span
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a
                                ...
                                target="_blank"
                                class="border-black hover:border-black hover:bg-black dark:hover:border-white dark:hover:bg-white inline-block rounded-sm border bg-[#1b1b18] px-5 py-1.5 text-sm leading-normal text-primary-foreground dark:border-[#eeeeec] dark:bg-[#eeeeec] dark:text-[#1C1C1A]"
                            >
                                Deploy now
                            </a>
                        </li>
